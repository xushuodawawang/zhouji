...
class SettingsRepository {
  ...
  Future<void> save(AppSettings settings) => _database.saveSettings(
    AppSettingsTableCompanion(
      ...
      focusPlaylistJson: Value(settings.focusPlaylistJson),
      focusLockEnabled: Value(settings.focusLockEnabled),
      completionSoundEnabled: Value(settings.completionSoundEnabled),
  ...
  AppSettings _fromRow(AppSettingsRow row) => AppSettings(
    ...
    focusPlaylistJson: row.focusPlaylistJson,
    focusLockEnabled: row.focusLockEnabled,
    completionSoundEnabled: row.completionSoundEnabled,
